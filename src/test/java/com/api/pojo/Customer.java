...
public class Customer {
    ...
    public Customer(String first_name, String last_name, String mobile_number,
                    String email_id, String mobile_number_alt, String email_id_alt) {
    ...
    public void seteEmail_id_alt(String mail_id_alt) {
        this.email_id_alt = mail_id_alt;
    }
